    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equals("")) {
                    Toast.makeText(PMainActivity.this, "Name required!", Toast.LENGTH_SHORT).show();

                }
                else if(account.equals("")){
                    Toast.makeText(PMainActivity.this,"Account Number required",Toast.LENGTH_SHORT).show();
                }
                else if(security.equals("")){
                    Toast.makeText(PMainActivity.this,"Security code required",Toast.LENGTH_SHORT).show();
                }
                else if(expiry.equals("")){
                    Toast.makeText(PMainActivity.this,"Expiry Data required",Toast.LENGTH_SHORT).show();
                }
                else{
                    Model MainActivity =new Model(Id,name,account,security,expiry);
                    database.child(Id).setValue(MainActivity);
                    Toast.makeText(PMainActivity.this,"done",Toast.LENGTH_SHORT).show();
