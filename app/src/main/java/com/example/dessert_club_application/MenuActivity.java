...
public class MenuActivity extends AppCompatActivity {
    ...
    public void openCardCake(){
        Intent intent = new Intent( this, com.example.dessert_club_application.CakeActivity.class);
        startActivity(intent);
    }
    public void openCardIce(){
        Intent intent = new Intent( this, com.example.dessert_club_application.IcecreamActivity.class);
        startActivity(intent);
    }
    public void openCardMousse(){
        Intent intent = new Intent( this, com.example.dessert_club_application.MousseActivity.class);
        startActivity(intent);
    }
}