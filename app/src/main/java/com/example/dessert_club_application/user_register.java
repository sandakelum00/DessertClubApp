    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_confirm_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String user_confirm_password=confirm_password_register.getText().toString();
                ...
                if (user_email.isEmpty()){
                    ...
                    password_register.setError("Please Enter the password!");
                    password_register.requestFocus();
                }
                else if (user_confirm_password.isEmpty()){
                    confirm_password_register.setError("Please Re-enter the password!");
                    confirm_password_register.requestFocus();
                }
                else if(user_password.length()<5){
                    password_register.setError("Please Enter more than 5 characters!");
                    password_register.requestFocus();
                }
                else if(!user_password.equals(user_confirm_password)){
                    confirm_password_register.setError("Please match the passwords!");
                    confirm_password_register.requestFocus();
                }
                else if (user_email.isEmpty() && user_password.isEmpty() && user_confirm_password.isEmpty()){
    ...
    private void insertData(){
        ...
        if (name.isEmpty()){
            ...
            confirm_password_register.requestFocus();
                ...
                && phone.isEmpty() && password.isEmpty() && confirm_password.isEmpty() ){
            Toast.makeText(user_register.this, "Your fields are empty!",Toast.LENGTH_SHORT).show();
        }

        else {
            dataHolder dataHolder_object = new dataHolder(name,email,street,city,phone);

            root.push().setValue(dataHolder_object);

            Intent intent2=new Intent(user_register.this, login.class);
